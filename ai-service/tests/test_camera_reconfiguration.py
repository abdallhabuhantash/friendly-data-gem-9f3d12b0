...
def runtime_stub():
    stub = SimpleNamespace(
        ...
        _analysis_error={CAM_A: "RuntimeError"},
        _frames_seen={CAM_A: 5, CAM_B: 3},
        _frames_analysed={CAM_A: 5, CAM_B: 3},
        _last_analysis_at={CAM_A: 1.0, CAM_B: 1.0},
        _skip_reason={CAM_A: "duplicate_captured_frame"},
